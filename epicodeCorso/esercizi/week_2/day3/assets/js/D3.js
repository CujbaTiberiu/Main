...
document.getElementById('esercizio1').innerHTML = 'il numero piu grande è' + ' ' + maggiore;
...
let numero6 = 8;
let numero7 = 4;
var otto = (numero6 == 8 || numero7 == 8 || numero6 + numero7 == 8 || numero6 - numero7 == 8 || numero7 - numero6 == 8 ) ? 'verificato' : 'non verificato';
console.log(otto);
...
if(totalShoppingCart > 50){
  ...
  document.getElementById('esercizio5').innerHTML = 'Hai diritto alla spedizione gratuita - Totale da pagare' + ' ' + totalCost;
  console.log( 'Hai diritto alla spedizione gratuita - Totale da pagare' + ' ' + totalCost);
} else {
  totalCost = totalShoppingCart + spedizione;
 document.getElementById('esercizio5').innerHTML = 'Non hai il diritto alla spedizione gratuita - Totale da pagare' + ' '+ totalCost;
console.log('Non hai il diritto alla spedizione gratuita - Totale da pagare' + ' '+ totalCost);
}
...
if(scontato > 50){
  totalCost = scontato;
  document.getElementById('esercizio6').innerHTML = 'Hai diritto alla spedizione gratuita - Totale da pagare' + ' ' + totalCost;
  console.log( 'Hai diritto alla spedizione gratuita - Totale da pagare' + ' ' + totalCost);
} else {
  totalCost = scontato + spedizione;
  document.getElementById('esercizio6').innerHTML = 'Non hai il diritto alla spedizione gratuita - Totale da pagare' + ' '+ totalCost;
  console.log('Non hai il diritto alla spedizione gratuita - Totale da pagare' + ' '+ totalCost);
}
